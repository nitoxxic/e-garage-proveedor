...
class RetirarVehiculoDelGarage extends StatefulWidget {
  static const String name = 'RetirarVehiculoDelGarage';
  final Garage garage;

  const RetirarVehiculoDelGarage({Key? key, required this.garage})
      : super(key: key);

  @override
  State<RetirarVehiculoDelGarage> createState() =>
      _RetirarVehiculovehiculoState();
}

class _RetirarVehiculovehiculoState extends State<RetirarVehiculoDelGarage> {
  ...
  Future<void> _egresarVehiculo(String patenteBuscado, String idGarage) async {
          ...
          Positioned(
              ...
              child: Container(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    context.push('/listaDeGarageParaEgresarVehiculos');
                  },
                ),
              ))
        ],
